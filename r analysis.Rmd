...
ggplot(data = summary_datas) +
  ...
  labs(title = "Rider Membership Data", subtitle = "variation in the number of registered riders based on category") +ylab("Percentage distribution of riders by category")+
